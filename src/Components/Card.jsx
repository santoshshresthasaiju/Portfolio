...
const Card = () => {
    ...
    return (
        <div className='relative bg-sky-200 px-8 md:px-16 lg:px-24 text-white text-center py-16 mb-24' id='home'>
            ...
            <div className="flex space-x-4 py-4 mt-16">
                <a href="https://www.github.com" target="_blank" rel="noopener noreferrer" className="bg-neutral-900 rounded-full p-3 inline-block text-white hover:text-gray-400">
                    <FontAwesomeIcon icon={faGithub} size="xl" />
                </a>
                <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="bg-insta-gradient rounded-full p-3 inline-block text-white hover:text-gray-400">
                    <FontAwesomeIcon icon={faInstagram} size="xl" />
                </a>
                <a href="https://www.linkedin.com/in/santosh-shrestha-saiju" target="_blank" rel="noopener noreferrer" className="bg-sky-500 rounded-full p-3 inline-block text-white hover:text-gray-400">
